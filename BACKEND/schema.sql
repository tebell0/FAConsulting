...
-- ── Admin users ───────────────────────────────────────────────────
-- password_hash stores a bcrypt hash (generated by seed-admin.js).
-- Run `node seed-admin.js` after creating this table to insert the
...
-- NOTE: Do NOT insert admin credentials here in plain text.
-- Use the seed script instead:  cd BACKEND && node seed-admin.js
