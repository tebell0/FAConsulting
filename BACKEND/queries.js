...
export async function updateDeliveryLink(pool, id, link, password = null, token = null) {
  await q(pool, `
    UPDATE appointments SET delivery_link = ?, delivery_password = ?, delivery_token = ?, status = 'delivered' WHERE id = ?
  `, [link, password, token, id])
}
